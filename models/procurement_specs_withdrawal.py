...
class ProcurementSpecsWithdrawal(models.Model):
    ...
    name = fields.Char(string="Withdrawal Name", required=True)
    partner_id = fields.Many2one('res.partner', string="Partner")
    payment_receipt_ref = fields.Char(string="Payment Receipt Reference")
    withdrawer_name = fields.Char(string="Withdrawer Name")
    withdrawer_function = fields.Char(string="Withdrawer Function")
